...
namespace Lab2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine(" ");
                Console.WriteLine(" 1 - С помощью класса DateTime вывести на консоль названия месяцев на французском языке."+
                " По желанию обобщить на случай, когда язык задается с клавиатуры. \n");
                Console.WriteLine(" 2 - Рассчитать максимальную степень двойки, на которую делится произведение подряд идущих"+
                 "чисел от a до b (числа целые 64-битные без знака). \n");
                Console.WriteLine(" 3 - Дана строка, содержащая число с десятичной точкой. Преобразовать эту строку в число" +
                "действительного типа (не пользуясь стандартным Parse/TryParse). \n");
